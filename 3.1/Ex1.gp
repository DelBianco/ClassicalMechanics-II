...
set ytics (0,'π/4' pi/4,  'π/2' pi/2, '3π/4' 3*pi/4, 'π' pi)
...
plot "Out0.1-0.3.dat"  title ' ' w l ls 2,\
	"Out1.5-0.3.dat"  title '{/Symbol W} = 0.3' w l ls 3,\
	"Out2-0.3.dat"    title ' ' w l ls 6,\
	"Out0.1-1.0.dat"  title ' ' w l ls 9,  \
	"Out1.5-1.0.dat"  title '{/Symbol W} = 1.5' w l ls 11,\
	"Out2.0-1.0.dat"  title ' ' w l ls 13,\
	"Out0.1-1.2.dat"  title ' ' w l ls 10,\
	"Out1.5-1.2.dat"  title '{/Symbol W} = 2.1' w l ls 12,\
	"Out2.0-1.2.dat"  title ' ' w l ls 14,\
